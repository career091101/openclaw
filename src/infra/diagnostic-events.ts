...
export type DiagnosticToolValidationEvent = DiagnosticBaseEvent & {
...
export type DiagnosticSelfCorrectionEvent = DiagnosticBaseEvent & {
  type: "agent.self_correction";
  sessionKey?: string;
  toolName: string;
...
export type DiagnosticOrchestrationTaskEvent = DiagnosticBaseEvent & {
...
export type DiagnosticOrchestrationTripwireEvent = DiagnosticBaseEvent & {
  type: "orchestration.tripwire";
  orchestrationId: string;
  metric: "cost" | "tokens" | "time";
  value: number;
  threshold: number;
  action: "paused" | "aborted";
};
...
export type DiagnosticEventPayload =
  ...
  | DiagnosticToolValidationEvent
  | DiagnosticSelfCorrectionEvent
  | DiagnosticOrchestrationTaskEvent
  | DiagnosticOrchestrationTripwireEvent;
