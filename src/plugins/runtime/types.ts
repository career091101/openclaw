...
type CreateMemoryUpdateTool =
  typeof import("../../agents/tools/memory-tool.js").createMemoryUpdateTool;
type CreateMemoryForgetTool =
  typeof import("../../agents/tools/memory-tool.js").createMemoryForgetTool;
type GetMemorySearchManager =
  typeof import("../../memory/search-manager.js").getMemorySearchManager;
...
export type PluginRuntime = {
  ...
  tools: {
    ...
    createMemoryUpdateTool: CreateMemoryUpdateTool;
    createMemoryForgetTool: CreateMemoryForgetTool;
