...
export const TOOL_GROUPS: Record<string, string[]> = {
  ...
  "group:memory": ["memory_search", "memory_get", "memory_write", "memory_update", "memory_forget"],
  ...
  "group:nodes": ["nodes"],
  // Orchestration tools
  "group:orchestration": ["delegate_task", "check_task_status", "submit_result", "request_review"],
  // Self-improve tools
  "group:self-improve": ["evaluate_tip", "record_tip", "check_improve_status"],
