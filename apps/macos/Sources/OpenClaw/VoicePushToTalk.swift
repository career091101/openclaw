...
actor VoicePushToTalk {
    ...
    private func startRecognition(localeID: String?, sessionID: UUID) async throws {
        ...
        // Use nil format + ObjC exception catcher for safety.
        ...
        try ObjCExceptionCatcher.perform {
            unsafeInput.installTap(onBus: 0, bufferSize: 2048, format: nil) { buffer, _ in
